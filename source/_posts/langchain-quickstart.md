...
老师反复强调过一句话：**"LangChain 是给大模型应用做脚手架的"**。一开始我以为又是什么花里胡哨的概念，自己动手敲了一遍代码，发现它确实把"调大模型"这件本来挺折腾的事，变得像拼乐高一样有章法。

这篇笔记是我自己学习时整理的思路，尽量用大白话讲清楚。
...
LangChain 的"乐高块"主要就这六块，业内缩写是 M-P-I-Me-C-A，我给你翻译成人话：
